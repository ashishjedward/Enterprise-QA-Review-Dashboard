          ...
          <div className="space-y-3">
            ...
            <div className="p-3 rounded bg-slate-50 border border-slate-200/80">
              <div className="flex items-center justify-between text-[11px] text-slate-500 font-semibold mb-1">
                ...
                >
                  Net: {formatCurrency(currentCommercial.netCommercialImpact)}
                </span>
              </div>
              <div className="grid grid-cols-2 gap-2 text-xs mt-2">
                <div>
                  ...
                  <span className="font-bold text-rose-700">
                    {formatCurrency(currentCommercial.penaltyPaid)}
                  </span>
                </div>
                <div>
                  <span className="text-[10px] text-slate-400 uppercase block">Reward Earned</span>
                  <span className="font-bold text-emerald-700">
                    {formatCurrency(currentCommercial.rewardEarned)}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="p-3 rounded bg-slate-50 border border-slate-200/80">
              <div className="flex items-center justify-between text-[11px] text-slate-500 font-semibold mb-1">
                ...
                >
                  Net: {formatCurrency(periodCommercial.netCommercialImpact)}
                </span>
              </div>
              <div className="grid grid-cols-2 gap-2 text-xs mt-2">
                <div>
                  ...
                  <span className="font-bold text-rose-700">
                    {formatCurrency(periodCommercial.penaltyPaid)}
                  </span>
                </div>
                <div>
                  <span className="text-[10px] text-slate-400 uppercase block">Cumulative Rewards</span>
                  <span className="font-bold text-emerald-700">
                    {formatCurrency(periodCommercial.rewardEarned)}
                  </span>
                </div>
              </div>
            </div>
